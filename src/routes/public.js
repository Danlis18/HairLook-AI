...
const quizSchema = z.object({
  // The default keeps photo flows opened before the gender-selector deploy
  // compatible. Current clients still require an explicit Woman/Man choice.
  gender: z.enum(['Woman','Man']).default('Woman'), ageRange: z.string().max(30).default('Not provided'), currentLength: z.string().max(40).default('Not provided'), desiredLength: z.string().max(60).default('Not provided'),
