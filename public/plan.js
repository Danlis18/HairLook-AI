...
let cfg=isUs
  ? {priceDisplayUsd:'14.99',compareAtPrice:'53.54',priceSavings:'38.55',discountPercent:72,siteLocale:locale,siteCurrency:'USD',generationTargetCount:10,demoMode:false,reviewerDemo:false,reviewerAiEnabled:false}
  : {priceDisplayUsd:locale==='pt-BR'?'36.49':'6.99',compareAtPrice:locale==='pt-BR'?'129.90':'24.99',priceSavings:locale==='pt-BR'?'93.41':'18.00',discountPercent:72,siteLocale:locale,siteCurrency:locale==='pt-BR'?'BRL':'USD',generationTargetCount:10,demoMode:false,reviewerDemo:false,reviewerAiEnabled:false};
const wait=ms=>new Promise(r=>setTimeout(r,ms));
const C={
  en:{security:'Secure payment',preparing:'Preparing order',almost:'Your order is almost ready.',linking:'We are securely connecting your photo and verified email.',items:['Photo ready','Email verified','Secure order ready'],offer:'SPECIAL OFFER',heading:'Your Personalized Collection',summary:'10 hairstyle previews prepared from your uploaded photo.',old:'$24.99',sale:'72% OFF · SAVE $18.00',note:'One-time payment<br>No subscription',includes:['✓ 10 personalized previews','✓ Multiple hairstyles','✓ Private email delivery'],agreement:'I agree to the <a href="/terms" target="_blank">Terms</a> and <a href="/refund" target="_blank">Refund Policy</a>.',choose:'Choose payment method →',protected:'🔒 Protected payment. Choose card or cryptocurrency.',reviewerOffer:'PROTECTED REVIEWER DEMO',reviewerChoose:'Choose free demo payment →',reviewerNote:'No charge. This isolated demo creates 10 labeled workflow previews.',reviewerAiNote:'No charge. This protected demo creates 10 real AI hairstyle previews from your photo.',accept:'Confirm the Terms and Refund Policy before continuing to payment.',opening:'Opening secure payment…',errorTitle:'Something went wrong',refresh:'Refresh this page.',safe:'Your verified email and uploaded photo are safe. If the problem continues, contact support.'},
  'pt-BR':{security:'Pagamento seguro',preparing:'Preparando pedido',almost:'Seu pedido está quase pronto.',linking:'Estamos vinculando sua foto ao seu e-mail verificado com segurança.',items:['Foto pronta','E-mail verificado','Pedido seguro pronto'],offer:'OFERTA ESPECIAL',heading:'Sua Coleção Personalizada',summary:'10 prévias de penteados preparadas com a foto enviada.',old:'R$ 129,90',sale:'72% OFF · ECONOMIZE R$ 93,41',note:'Pagamento único<br>Sem assinatura',includes:['✓ 10 prévias personalizadas','✓ Vários penteados','✓ Entrega privada por e-mail'],agreement:'Concordo com os <a href="/terms" target="_blank">Termos</a> e a <a href="/refund" target="_blank">Política de Reembolso</a>.',choose:'Escolher forma de pagamento →',protected:'🔒 Pagamento protegido. Escolha cartão ou criptomoeda.',reviewerOffer:'DEMO PROTEGIDA PARA REVISÃO',reviewerChoose:'Escolher pagamento demo gratuito →',reviewerNote:'Sem cobrança. Esta demo isolada cria 10 prévias identificadas do fluxo.',reviewerAiNote:'Sem cobrança. Esta demo protegida cria 10 prévias reais de penteados com IA usando sua foto.',accept:'Confirme os Termos e a Política de Reembolso antes de continuar para o pagamento.',opening:'Abrindo pagamento seguro…',errorTitle:'Algo deu errado',refresh:'Atualize esta página.',safe:'Seu e-mail verificado e sua foto enviada estão seguros. Se o problema continuar, entre em contato com o suporte.'}
}[locale];
...
async function init(){
  ...
  applyPrice();
  if(cfg.reviewerDemo){setText('#offerBadge',C.reviewerOffer);setText('#checkoutButton',C.reviewerChoose);setText('#checkoutNote',cfg.reviewerAiEnabled?C.reviewerAiNote:C.reviewerNote);}
  animatePlan();
}
